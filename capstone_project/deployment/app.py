...
model_path = hf_hub_download(repo_id="p-kansal/engine-failure-prediction", filename="best_capstone_model_v1.joblib")
...
LubOilPressure = st.number_input("Lubricating Oil Pressure", min_value=0, max_value=10, value=3)
FuelPressure = st.number_input("Fuel Pressure", min_value=0, max_value=25, value=7)
CoolantPressure = st.number_input("Engine Coolant Pressure", min_value=0, max_value=10, value=2)
LubOilTemp = st.number_input("Lubricating Oil Temperature (°C)", min_value=60, max_value=100, value=75)
CoolantTemp = st.number_input("Engine Coolant Temperature (°C)", min_value=60, max_value=100, value=75)
